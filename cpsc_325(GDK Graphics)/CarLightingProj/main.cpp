...
vec4 light_position(0,10,10,1); // we will experiment with this position
...
init()
{
    ...
    // program = InitShader( "vertex.glsl", "fragment.glsl" );    // no  shading
     program = InitShader( "C:\\Users\\KathieYerion\\Documents\\Kathie.YERION\\graphics\\CarLightingProj\\CarLightingProj\\vShader53.glsl", "C:\\Users\\KathieYerion\\Documents\\Kathie.YERION\\graphics\\CarLightingProj\\CarLightingProj\\fShader53.glsl" );  // gouraud shading
