...
#include <cstdlib>
#include <iostream>
#include <ctime> //in order to grab things from the clock
using namespace std;
...
{
    public:
        //creates a default grid of 8 X 8 and generates heights
        FractalLandHeights();

        //creates a grid of a desired size and generates heights
        //pre s is assigned
        //post grid is 2^s by 2^s with heights generated  POWER of 2 important fo algorithm
