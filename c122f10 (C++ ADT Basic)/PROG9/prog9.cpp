...
{
   cout << "===================================================" << endl;
   cout << "{  This program will test the clist.h functions : }" << endl; 
   cout << "{ constructor, copy constructor, DeleteIth,       }" << endl;
   cout << "{ InsertIth, GetLength, IsEmpty,                  }" << endl;
   cout << "{ RetrieveIth, Search, Print, ReversePrint        }" << endl;
   cout << "===================================================" << endl;
}
...
//@returns numlist with integers from the file
//@usage MakeList(9, list);
void MakeEventList(int tot, List& numlist)
{
   ifstream infile;
   int num;
   bool ok;
