...
//@               copy the front, get the size, print
...
public:
   ...
   void Enqueue(const QItemType& newItem, bool& ok);
   ...
   void GetFront(QItemType& frontItem) const;
