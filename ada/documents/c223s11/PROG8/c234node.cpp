...
//@                   an mdata array of 3 Citems
//@                   and an mptrs array of 4 pointers
...
//@       the pointers are left, mid right and midleft
...
//@       the pointers are left, mid right, right and midleft
...
//@pre child has bee split and has this node has recieved a new Citem into mdata[] 
...
void C234node::AdjustParentsPtrs(const int indexPlacement)
{
   ...
   if (indexPlacement == 0)
   {
      temp1 = ReturnPtr(indexPlacement + 1);
      temp2 = ReturnPtr(indexPlacement + 2);
      ConnectPtr(indexPlacement + 2, temp1);
      ConnectPtr(indexPlacement + 3, temp2);
   } else if (indexPlacement == 1) {
      temp1 = ReturnPtr(indexPlacement + 1);
      ConnectPtr(indexPlacement + 2, temp1);
   }
}
...
//@outputs to a file or the monitor a C234node object
//@pre rhs234node exists. output is open.
//@post contents of rhs234node have been output
//@param output
//@param rhs234node
//@usage cout << rhs234node << endl;   
