...
//@post: the item of the node is leftItem, the pointers are left and midleft
...
//@param parent
//@usage node.ConnectsToNode(mparent.mptrs[1])
void ConnectsToThisNode(C234node*& node);
...
//@pre child has bee split and this node has recieve a new Citem into mdata[] 
