...
//@date March 28, 2011
//@file prog6.cpp
//@description: This program will test many subcases of the 6 types of insert that a 
//@             AVL (Adelson, Velski, & Landis) undergoes.
...
void InvisibleBuildTree(ifstream& infile, ofstream& outfile, cavltree& avlTree, int number);
...
void InvisibleTempBuildTree(ifstream& infile, ofstream& outfile, cavltree avlTree, int number);
...
void InsertInTree(ifstream& infile, ofstream& outfile, cavltree temp);
...
void BuildTree(ifstream& infile, ofstream& outfile, cavltree& avlTree);
...
void ShortSide(ifstream& infile, ofstream& outfile)
{
	cavltree baseTree, secondTree, thirdTree, fourthTree;
	int i;
...
void RotateRight(ifstream& infile, ofstream& outfile)
{
	cavltree baseTree, secondTree, thirdTree, lastTree;
	int i;
...
void DoubleLeftRight(ifstream& infile, ofstream& outfile)
{
	cavltree baseTree, secondTree, lastTree;
	int i;
