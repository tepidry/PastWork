...
init()
{
    ...
    program = InitShader( "/home/GONZAGA/yerion/Documents/ASPHERE/LrdraperSphere7/vertex.glsl", "/home/GONZAGA/yerion/Documents/ASPHERE/LrdraperSphere7/fragment.glsl" );
    ...
    GLuint vao[11];                                                                       //an Array of objects
    ...
    mySphere.createVAO(vao[10], program);
...
// draws solid Line. The wire color is always green
//pre scene camera and exists
//post Line is drawn
//usage drawRotationAxes(mv);
void
...
display( void )
{
    ...
    //the commented out either mat4 or rotation of an angle is equvalent of it's neighboring mat4 or rotation of an angle
    ...
    glUniformMatrix4fv( model_view, 1, GL_TRUE, mv );
    drawSphere(vec4(0.0, 0.0, 0.0, 0.0));
    mv = mvMatrixStack.popMatrix();
...
main( int argc, char **argv )
{
  ...
  //  glutInitContextProfile( GLUT_CORE_PROFILE );
    glutCreateWindow( "Sphere and a Box" );
