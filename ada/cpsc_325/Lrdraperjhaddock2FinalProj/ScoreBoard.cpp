...
{
    zeroGrayOneYellow[0] = vec4(.5, .5, 0, 1);
...
//makes a single bar that is either dark or bright yellow created from the cube class shich is part of shape class
//pre bar doesn't exist
//post bar does exist
//param mv
//	onOff
//usage makeBar(mv, onOff);
