...
init()
{
    ...
    program = InitShader( "/ada/rdraper/LCarNavigationsProjStart/vertex.glsl", "/ada/rdraper/LCarNavigationsProjStart/fragment.glsl" );
...
void tumble(const mat4& rx, const mat4& ry, vec4 tumblePoint)
{
    ...
    ytransform = Translate(tumblePoint) * ry * Translate(- tumblePoint);
    //xtransform = rx * view;

    newView =  xtransform * view * ytransform;
    //mat4 newViewRotationInverse = transpose(newView);
    //eye = eye - newViewRotationInverse * newView;
    viewRotation = newView;
    //viewRotation[3] = vec4(0,0,0,1); last colum


    //ytransform = ytransform * ry;
