...
//  I chose that all you have to do when you compile is type ./a.out instead of ./a.out in that it will just accept your current 
...
int main(int argc, char *argv[]) 
{
    ...
    do {
        ...
        while((upperDirent = readdir(parentDir)) != NULL)
        {
